mydata<- read.csv("SL_5YEARS.csv", header=T, sep=',')
...
strip=TRUE,
main = paste("Calendar Heatmap of ", varname, sep = ""),
scales = list(
x = list(
...
calendarHeat(mydata$Date, mydata$SL_Value, varname="Daily Service Level")
